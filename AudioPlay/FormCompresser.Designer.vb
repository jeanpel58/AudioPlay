...
Partial Class FormCompresser
    ...
    Friend WithEvents BtnDebugSaveTransition As Button
    Friend WithEvents BtnRunAllHeadless As Button
    ...
    Private Sub InitializeComponent()
        ...
        BtnDebugSaveTransition = New Button()
        BtnRunAllHeadless = New Button()
        ...
        ' 
        ' BtnDebugSaveTransition
        ' 
        BtnDebugSaveTransition.Location = New Point(373, 692)
        BtnDebugSaveTransition.Name = "BtnDebugSaveTransition"
        BtnDebugSaveTransition.Size = New Size(110, 23)
        BtnDebugSaveTransition.TabIndex = 0
        BtnDebugSaveTransition.Text = "Save Transition"
        ' 
        ' BtnRunAllHeadless
        ' 
        BtnRunAllHeadless.Location = New Point(495, 692)
        BtnRunAllHeadless.Name = "BtnRunAllHeadless"
        BtnRunAllHeadless.Size = New Size(110, 23)
        BtnRunAllHeadless.TabIndex = 1
        BtnRunAllHeadless.Text = "All Headless"
        ' 
        ' CheckBoxEjectCD
        ' 
        ...
        Controls.Add(BtnDebugSaveTransition)
        Controls.Add(BtnRunAllHeadless)
